...
import { EXPENSE_CATEGORIES_HARIAN, EXPENSE_CATEGORIES_KHUSUS, formatInputRupiah, parseInputRupiah } from '../utils/format';
...
export default function ExpenseModal({ onClose, onComplete }: { onClose: () => void; onComplete: () => void }) {
  ...
  const handleSubmit = async () => {
    ...
    if (balanceBefore < amt) { setLoading(false); return; }
